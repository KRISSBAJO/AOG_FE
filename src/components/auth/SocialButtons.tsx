...
function GoogleIcon() {
  return (
    <svg className="h-4 w-4" viewBox="0 0 24 24" aria-hidden>
      ...
      <path
        fill="#EA4335"
        d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1A11 11 0 0 0 2.18 7.06L5.85 9.9C6.71 7.3 9.14 5.38 12 5.38Z"
      />
    </svg>
  );
}
...
/** SSO providers row — hook the onClick handlers to your auth flow. */
