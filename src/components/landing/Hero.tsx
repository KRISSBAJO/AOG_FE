        ...
        >
          <div className="w-full max-w-xl overflow-hidden rounded-2xl border border-white/[0.12] bg-[#121827]/90 shadow-2xl shadow-black/35">
            <div className="flex items-center justify-between border-b border-white/10 px-5 py-4">
              ...
              <span className="rounded-lg bg-amber-400 px-3 py-1.5 text-xs font-black text-[#0B1120]">
                Live
              </span>
            </div>
            ...
            <div className="p-5">
              ...
              <div className="mt-4 rounded-xl border border-white/10 bg-white/[0.035] p-4">
                ...
                <div className="flex h-20 items-end gap-2">
                  {[42, 56, 38, 64, 50, 76, 58].map((height, index) => (
                    <span
                      key={index}
                      className="flex-1 rounded-t-md bg-amber-400/45 last:bg-amber-400"
                      style={{ height: `${height}%` }}
                    />
                  ))}
                </div>
                ...
                {[
                  ...
                  <div key={id} className="flex items-center justify-between rounded-xl border border-white/10 bg-white/[0.035] px-4 py-3">
                    <div className="min-w-0">
                      <span className="rounded-md bg-amber-400/15 px-2 py-1 text-xs font-black text-amber-300">{id}</span>
